  ...
  <div class="wrapper">
    ...
    <div class="s2-row">
      <div class="s2-col">
        ...
        <div class="des">
          <div>组件丰富 <span class="divider"></span> 功能全面</div>
      ...
      <div class="s2-col">
        ...
        <div class="des">
          <div>一步上手 <span class="divider"></span> 按需加载</div>
    ...
    <div class="s2-row">
      <div class="s2-col">
        ...
        <div class="des">
          <div>体积小巧 <span class="divider"></span> 性能出众</div>
      ...
      <div class="s2-col">
        ...
        <div class="des">
          <div>简易定制 <span class="divider"></span> 多种风格</div>
...
<section class="home-s3">
  <div class="wrapper">
    ...
    <p>我们为您提供丰富的 Sketch symbol 化的组件资源库，你可以使用资源库快速设计应用程序。</p>
    <a href="http://p.tb.cn/rmsportal_3436_AntDesignMobile_20Template_20V1.0.sketch" class="ant-btn ant-btn-lg ant-btn-ghost">立即下载</a>
  </div>
</section>
