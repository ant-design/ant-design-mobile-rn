      ...
      styles={css`
       @layer global {
        ...
        .markdown code {
          ...
          padding: 0.2em 0.4em;
          font-size: 0.9em;
          background: ${customToken.siteMarkdownCodeBg};
          border: 1px solid ${token.colorSplit};
          border-radius: ${token.borderRadiusSM}px;
        }

        .markdown pre {
          font-family: ${customToken.codeFamily};
          background: ${customToken.siteMarkdownCodeBg};
        ...
        .markdown .dumi-default-source-code {
          margin: 1em 0;
          background-color: ${customToken.siteMarkdownCodeBg};
          border-radius: ${token.borderRadius}px;
          > pre.prism-code {
        ...
        [data-prefers-color='dark'] {
          .markdown .dumi-default-source-code {
            background-color: ${customToken.siteMarkdownCodeBgDark};
          }
        }
        ...
        [id^='grid-demo-'] {
          ...
          .code-box-demo ${antCls}-row > div:not(.gutter-row) {
            ...
            &:nth-child(2n + 1) {
              background: ${new FastColor(demoGridColor)
                .setA(0.75)
                .toHexString()};
            }
          }
