    ...
    <div className="home-sections main-wrapper">
        ...
        <div className="wrapper">
          ...
          <div className="s2-row">
            ...
            <div className="s2-col">
              ...
              <div className="des">
                <div>
                  One Step To Get Start <span className="divider"></span> Loaded
                  on demand
                </div>
                <p>
      ...
      <section className="home-s3">
        <div className="wrapper">
          ...
          <p>
            We provide you with a rich resource of Sketch symbolized components
            to quickly design your application.
          </p>
          <a
