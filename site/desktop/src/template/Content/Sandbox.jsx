...
<head>
  ...
  <style>
  @font-face {
    src: url('https://unpkg.com/@ant-design/icons-react-native@2.0.0/fonts/antoutline.ttf');
      ...
      'package.json': {
        content: {
          ...
          dependencies: {
            ...
            '@react-native-community/cameraroll': 'latest',
            '@react-native-community/segmented-control': '2.2.1',
            'react-native-gesture-handler/DrawerLayout': '~1.10.2',
            'react-native-gesture-handler/Swipeable': '~1.10.2',
          },
          browserslist: [
            '>0.2%',
            'not dead',
