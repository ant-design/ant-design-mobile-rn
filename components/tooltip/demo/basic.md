...
[Demo Source Code](https://github.com/ant-design/ant-design-mobile-rn/blob/master/components/tooltip/demo/basic.tsx)

```jsx
import React, { useEffect, useState } from 'react'
import { ScrollView, Text, View } from 'react-native'
import { Button, Icon, List, Toast, Tooltip } from '@ant-design/react-native'
import { Action, TooltipProps } from '@ant-design/react-native/lib/tooltip'
...
export const description = 'Tooltip example';
```
