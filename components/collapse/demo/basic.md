...
[Demo Source Code](https://github.com/ant-design/ant-design-mobile-rn/blob/master/components/collapse/demo/basic.tsx)
      ...
      <List renderHeader="自定义折叠图标">
        <Collapse
          ...
          <Collapse.Panel
            ...
            如果你给 arrow 属性传入的是是一个渲染函数，那么 @ant-design/react-native
